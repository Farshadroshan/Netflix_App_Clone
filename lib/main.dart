...
import 'package:netflix/screens/splach_screen.dart';
...
void main() async{
  ...
  await Hive.openBox<MovieDownloadModel>('downloads');
  runApp(const MyApp());
}
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        // the application has a purple toolbar.P Then, without quitting the app,
